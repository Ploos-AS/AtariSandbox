...
- deny-by-default runtime policy state
- bounded evidence object list
- relative path, byte count, SHA-256 and kind for every object

Paths are relative to the analysis directory. Any path escaping the analysis directory fails closed.
...
Status: implementation committed; runtime qualification pending.
